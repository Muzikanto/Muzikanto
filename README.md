...
I'm passionate about Typescript, Rust, React, NextJs, NestJs and also taking a look at solidity
...
<div style="display: flex; flex: 1; align-items: center; flex-direction: row; width: 100%;>
  ...
  <img height="50" width="80" src="https://github.com/grafana/grafana/blob/main/docs/logo-horizontal.png">
